...
-- Services
INSERT INTO services (id, name_es, name_en, description_es, description_en, type, resource_id, pricing_model, price_pen, max_spots, duration_minutes, is_addon) VALUES
  ('b1000000-0000-0000-0000-000000000001', 'Paddle Bahia', 'Bay Paddle', 'Paddle en la bahia de La Punta.', 'Paddle in the bay of La Punta.', 'paddle', 'a1000000-0000-0000-0000-000000000002', 'per_person', 130, 6, 90, false),
  ('b1000000-0000-0000-0000-000000000002', 'Paddle Camotal', 'Camotal Paddle', 'Paddle hasta El Camotal.', 'Paddle to El Camotal.', 'paddle', 'a1000000-0000-0000-0000-000000000002', 'per_person', 150, 6, 120, false),
  ('b1000000-0000-0000-0000-000000000003', 'Paddle Grupal', 'Group Paddle', 'Sesion grupal de paddle.', 'Group paddle session.', 'paddle', 'a1000000-0000-0000-0000-000000000003', 'flat', 500, 5, 90, false),
  ('b1000000-0000-0000-0000-000000000004', 'Bahia — Anchor & Chill', 'Bay — Anchor & Chill', 'Paseo en lancha por la bahia con ancla.', 'Boat trip with anchoring in the bay.', 'boat', 'a1000000-0000-0000-0000-000000000001', 'flat', 1200, 7, 180, false),
  ('b1000000-0000-0000-0000-000000000005', 'El Camotal — Anchor', 'El Camotal — Anchor', 'Viaje a El Camotal con ancla.', 'Trip to El Camotal with anchoring.', 'boat', 'a1000000-0000-0000-0000-000000000001', 'flat', 1500, 7, 240, false),
  ('b1000000-0000-0000-0000-000000000006', 'San Lorenzo Island', 'San Lorenzo Island', 'Excursion a la Isla San Lorenzo.', 'Excursion to San Lorenzo Island.', 'boat', 'a1000000-0000-0000-0000-000000000001', 'flat', 2000, 7, 300, false),
  ('b1000000-0000-0000-0000-000000000007', 'Wakeboard / Toys', 'Wakeboard / Toys', 'Wakeboard y juegos acuaticos.', 'Wakeboard and water toys.', 'boat', 'a1000000-0000-0000-0000-000000000001', 'per_person', 80, 7, 30, true),
  ('b1000000-0000-0000-0000-000000000008', 'Palomino Island', 'Palomino Island', 'Tour a las Islas Palomino.', 'Tour to Palomino Islands.', 'alliance', NULL, 'per_person', 120, 30, 180, false),
  ('b1000000-0000-0000-0000-000000000009', 'Velero Experience', 'Sailboat Experience', 'Experiencia en velero con Michele.', 'Sailboat experience with Michele.', 'alliance', 'a1000000-0000-0000-0000-000000000004', 'flat', 3000, 8, 240, false)
ON CONFLICT (id) DO NOTHING;
